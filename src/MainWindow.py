...
class Ui_MainWindowDesign(object):
    def setupUi(self, MainWindowDesign, QtApplication):
        ...
        MainWindowDesign.resize(362, 857)
        ...
        self.gridLayout_3 = QtWidgets.QGridLayout(self.basicInformation)
        ...
        self.gridLayout.addWidget(self.subjectCode, 0, 0, 1, 1, QtCore.Qt.AlignHCenter)
        ...
        self.datesBox = QtWidgets.QGroupBox(self.mainWindow)
        ...
        self.calendarDates = QtWidgets.QGroupBox(self.datesBox)
        ...
        self.verticalLayout_2.addWidget(self.endBox)
        ...
        MainWindowDesign.setTabOrder(self.tabWidget, self.filePathText)
        MainWindowDesign.setTabOrder(self.filePathText, self.subjectCodeText)
        ...
        MainWindowDesign.setTabOrder(self.addButton, self.useFileButton)
        MainWindowDesign.setTabOrder(self.useFileButton, self.startDateEdit)
    ...
    def retranslateUi(self, MainWindowDesign):
        ...
        self.planDocente.setText(_translate("MainWindowDesign", "<html><head/><body><p>Plan Docente</p></body></html>"))
        ...
        self.calendarDates.setTitle(_translate("MainWindowDesign", "Inicio y final del calendario"))
